<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="EmployeePayRollWebForms.Pages.Register" %>
        ...
        <div class="container">
            ...
            <div class="float-end me-2">
                ...
                <ul class="navbar-nav flex-grow-1 ">
                    ...
                    <li class="nav-item"><a class="nav-link btn btn-primary btn-sm text-white ms-4 me-4" runat="server" href="~/Pages/EmployeeList.aspx">DashBoard</a></li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-8 shadow-lg rounded-4" style="margin: 0px auto;">
                <br />
                <h1 class="text-primary text-center rounded-top">Register Here</h1>
                <hr />
                <br />
